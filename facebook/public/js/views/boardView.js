...
(function ($) {
	...
	app.boardView = Backbone.View.extend({
		...
		template: Handlebars.compile(
			...
			'{{#firstComplete round}}'+
				'<ul id="cardList">'+
					'<li class="col-xs-4 col-md-3 col-md-offset-1 cards" title="The 80\'s" style="background-image: url(https://i.imgur.com/MipnJcT.png); background-position: center center; background-repeat:no-repeat;"></li>' +
					'<li class="col-xs-4 col-md-3 cards" title="The 90\'s" style="background-image: url(https://i.imgur.com/Lg1khA7.png); background-position: center center; background-repeat:no-repeat;"></li>' +
				...
				'<ul id="cardList">' +
					...
					'<li class="col-xs-4 col-md-3 cards" title="Anything" style="background-image: url(https://i.imgur.com/qWizSL2.png); background-position: center center; background-repeat:no-repeat;"></li>' +
				'</ul>' +
			'{{/firstComplete}}'+
			'</div>'
		),
